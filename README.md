...
简介：合计六个小时做的捷径“sm.ms图床”｜此捷径不只能选择sm.ms图床，还可以选择PCFS图床，且sm.ms选项不用外网也可以使用。[点此下载](https://www.icloud.com/shortcuts/414e788852534c738eb926c190cd57f4)｜[社区链接](https://sharecuts.cn/shortcut/12628)
...
简介：此捷径可以快速查找你b站的个人空间信息，其中当然包括注册时间。（可以运用此捷径搞个每天晚上几点通知粉丝涨了多少的自动化）
...
我们的回答是：因为我们的每一个捷径都是精巧的，捷径里不必要的操作我们不会添加，我们希望我们所制作的捷径更好用，能帮助到更多的人，我们绝不会未经作者允许搬运他人的捷径。更不会整天做一些没有用的捷径(简称水捷径)。我们做捷径追求简单、易懂、好用、操作简便，让新手也能学习我们的捷径